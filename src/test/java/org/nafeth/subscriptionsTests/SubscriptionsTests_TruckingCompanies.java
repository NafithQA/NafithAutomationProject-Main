...
public class SubscriptionsTests_TruckingCompanies extends Configurations {

    // CREDIT CARD
    @Parameters("language")
    @Test(description = "MAMS_SUBSCRIPTION_PACKAGES_TC0001_PAY_10_1", enabled = true, alwaysRun = true, retryAnalyzer = RetryAnalyzer.class, priority = 1)
    public void MAMS_SUBSCRIPTION_PACKAGES_TC0001_PAY_10_1(String languageChosen) throws IOException, InterruptedException {
        ...
        SubscriptionsTests_TruckingCompanies subscriptionsTests = new SubscriptionsTests_TruckingCompanies();
    ...
    @Parameters("language")
    @Test(description = "MAMS_SUBSCRIPTION_PACKAGES_TC0001_PAY_10_2", enabled = true,  alwaysRun = true, retryAnalyzer = RetryAnalyzer.class, priority = 2)
    public void MAMS_SUBSCRIPTION_PACKAGES_TC0001_PAY_10_2(String languageChosen) throws IOException, InterruptedException {
        ...
        // Login to Nafeth from DB
        userAndPassAndFleetArray = databaseHandler.getUserAndPassAndFleetFromDataBase(TruckingCompaniesQueries.MAMS_SUBSCRIPTION_PACKAGES_TC0001_PAY_10_2);
        functions.waitForElementToBeClickable(loginPage.getUserNameField());
        loginPage.getUserNameField().sendKeys(userAndPassAndFleetArray.get(0));
        functions.waitForElementToBeClickable(loginPage.getPasswordField());
        loginPage.getPasswordField().sendKeys(userAndPassAndFleetArray.get(1));
    ...
    @Parameters("language")
    @Test(description = "MAMS_SUBSCRIPTION_PACKAGES_TC0001_PAY_10_3", enabled = true,  alwaysRun = true, retryAnalyzer = RetryAnalyzer.class, priority = 3)
    public void MAMS_SUBSCRIPTION_PACKAGES_TC0001_PAY_10_3(String languageChosen) throws IOException, InterruptedException {
        ...
        // Login to Nafeth from DB
        userAndPassAndFleetArray = databaseHandler.getUserAndPassAndFleetFromDataBase(TruckingCompaniesQueries.MAMS_SUBSCRIPTION_PACKAGES_TC0001_PAY_10_3);
        functions.waitForElementToBeClickable(loginPage.getUserNameField());
        loginPage.getUserNameField().sendKeys(userAndPassAndFleetArray.get(0));
        functions.waitForElementToBeClickable(loginPage.getPasswordField());
        loginPage.getPasswordField().sendKeys(userAndPassAndFleetArray.get(1));
    ...
    @Parameters("language")
    @Test(description = "MAMS_SUBSCRIPTION_PACKAGES_TC0001_PAY_10_4", enabled = true,  alwaysRun = true, retryAnalyzer = RetryAnalyzer.class, priority = 4)
    public void MAMS_SUBSCRIPTION_PACKAGES_TC0001_PAY_10_4(String languageChosen) throws IOException, InterruptedException {
        ...
        // Login to Nafeth from DB
        userAndPassAndFleetArray = databaseHandler.getUserAndPassAndFleetFromDataBase(TruckingCompaniesQueries.MAMS_SUBSCRIPTION_PACKAGES_TC0001_PAY_10_4);
        functions.waitForElementToBeClickable(loginPage.getUserNameField());
        loginPage.getUserNameField().sendKeys(userAndPassAndFleetArray.get(0));
        functions.waitForElementToBeClickable(loginPage.getPasswordField());
        loginPage.getPasswordField().sendKeys(userAndPassAndFleetArray.get(1));
    ...
    // POINT OF SALE
    @Parameters("language")
    @Test(description = "MAMS_SUBSCRIPTION_PACKAGES_TC0001_PAY_10_5", enabled = true,  alwaysRun = true, retryAnalyzer = RetryAnalyzer.class, priority = 5)
    public void MAMS_SUBSCRIPTION_PACKAGES_TC0001_PAY_10_5(String languageChosen) throws IOException, InterruptedException {
        ...
        // Login to Nafeth from DB
        userAndPassAndFleetArray = databaseHandler.getUserAndPassAndFleetFromDataBase(TruckingCompaniesQueries.MAMS_SUBSCRIPTION_PACKAGES_TC0001_PAY_10_5);
        functions.waitForElementToBeClickable(loginPage.getUserNameField());
        loginPage.getUserNameField().sendKeys(userAndPassAndFleetArray.get(0));
        functions.waitForElementToBeClickable(loginPage.getPasswordField());
        loginPage.getPasswordField().sendKeys(userAndPassAndFleetArray.get(1));
    ...
    @Parameters("language")
    @Test(description = "MAMS_SUBSCRIPTION_PACKAGES_TC0001_PAY_10_6", enabled = true,  alwaysRun = true, retryAnalyzer = RetryAnalyzer.class, priority = 6)
    public void MAMS_SUBSCRIPTION_PACKAGES_TC0001_PAY_10_6(String languageChosen) throws IOException, InterruptedException {
        ...
        // Login to Nafeth from DB
        userAndPassAndFleetArray = databaseHandler.getUserAndPassAndFleetFromDataBase(TruckingCompaniesQueries.MAMS_SUBSCRIPTION_PACKAGES_TC0001_PAY_10_6);
        functions.waitForElementToBeClickable(loginPage.getUserNameField());
        loginPage.getUserNameField().sendKeys(userAndPassAndFleetArray.get(0));
        functions.waitForElementToBeClickable(loginPage.getPasswordField());
        loginPage.getPasswordField().sendKeys(userAndPassAndFleetArray.get(1));
    ...
    @Parameters("language")
    @Test(description = "MAMS_SUBSCRIPTION_PACKAGES_TC0001_PAY_10_7", enabled = true,  alwaysRun = true, retryAnalyzer = RetryAnalyzer.class, priority = 7)
    public void MAMS_SUBSCRIPTION_PACKAGES_TC0001_PAY_10_7(String languageChosen) throws IOException, InterruptedException {
        ...
        // Login to Nafeth from DB
        userAndPassAndFleetArray = databaseHandler.getUserAndPassAndFleetFromDataBase(TruckingCompaniesQueries.MAMS_SUBSCRIPTION_PACKAGES_TC0001_PAY_10_7);
        functions.waitForElementToBeClickable(loginPage.getUserNameField());
        loginPage.getUserNameField().sendKeys(userAndPassAndFleetArray.get(0));
        functions.waitForElementToBeClickable(loginPage.getPasswordField());
        loginPage.getPasswordField().sendKeys(userAndPassAndFleetArray.get(1));
    ...
    @Parameters("language")
    @Test(description = "MAMS_SUBSCRIPTION_PACKAGES_TC0001_PAY_10_8", enabled = true,  alwaysRun = true, retryAnalyzer = RetryAnalyzer.class, priority = 8)
    public void MAMS_SUBSCRIPTION_PACKAGES_TC0001_PAY_10_8(String languageChosen) throws IOException, InterruptedException {
        ...
        // Login to Nafeth from DB
        userAndPassAndFleetArray = databaseHandler.getUserAndPassAndFleetFromDataBase(TruckingCompaniesQueries.MAMS_SUBSCRIPTION_PACKAGES_TC0001_PAY_10_8);
        functions.waitForElementToBeClickable(loginPage.getUserNameField());
        loginPage.getUserNameField().sendKeys(userAndPassAndFleetArray.get(0));
        functions.waitForElementToBeClickable(loginPage.getPasswordField());
        loginPage.getPasswordField().sendKeys(userAndPassAndFleetArray.get(1));
    ...
    // BALANCE
    @Parameters("language")
    @Test(description = "MAMS_SUBSCRIPTION_PACKAGES_TC0001_PAY_10_9", enabled = true,  alwaysRun = true, retryAnalyzer = RetryAnalyzer.class, priority = 9)
    public void MAMS_SUBSCRIPTION_PACKAGES_TC0001_PAY_10_9(String languageChosen) throws IOException, InterruptedException {
        ...
        // Login to Nafeth from DB
        userAndPassAndFleetArray = databaseHandler.getUserAndPassAndFleetFromDataBase(TruckingCompaniesQueries.MAMS_SUBSCRIPTION_PACKAGES_TC0001_PAY_10_9);
        functions.waitForElementToBeClickable(loginPage.getUserNameField());
        loginPage.getUserNameField().sendKeys(userAndPassAndFleetArray.get(0));
        functions.waitForElementToBeClickable(loginPage.getPasswordField());
        loginPage.getPasswordField().sendKeys(userAndPassAndFleetArray.get(1));
    ...
    @Parameters("language")
    @Test(description = "MAMS_SUBSCRIPTION_PACKAGES_TC0001_PAY_10_10", enabled = true,  alwaysRun = true, retryAnalyzer = RetryAnalyzer.class, priority = 10)
    public void MAMS_SUBSCRIPTION_PACKAGES_TC0001_PAY_10_10(String languageChosen) throws IOException, InterruptedException {
    ...
    @Parameters("language")
    @Test(description = "MAMS_SUBSCRIPTION_PACKAGES_TC0001_PAY_10_11", enabled = true,  alwaysRun = true, retryAnalyzer = RetryAnalyzer.class, priority = 11)
    public void MAMS_SUBSCRIPTION_PACKAGES_TC0001_PAY_10_11(String languageChosen) throws IOException, InterruptedException {
    ...
    @Parameters("language")
    @Test(description = "MAMS_SUBSCRIPTION_PACKAGES_TC0001_PAY_10_12", enabled = true,  alwaysRun = true, retryAnalyzer = RetryAnalyzer.class, priority = 12)
    public void MAMS_SUBSCRIPTION_PACKAGES_TC0001_PAY_10_12(String languageChosen) throws IOException, InterruptedException {
